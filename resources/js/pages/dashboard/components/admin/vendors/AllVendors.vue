<template>
    <div>
        <table
            ...
            class="table table-responsive table-bordered mt-2"
        >
            <thead>
                <tr>
            ...
            <tbody>
                ...
                >
                    ...
                    <td>
                        <span
                            @click="
                                emitVendorView(vendor.name, vendor.store_id)
                            "
                        ...
                        <span
                            @click="toggleActivation(vendor.store_id)"
                            :class="
                                vendor.status === 0
        ...
        <div class="info">
            <p style="font-weight: 900">
                These are list of vendors that have their shop profile already
                setup
            </p>
        </div>
    </div>

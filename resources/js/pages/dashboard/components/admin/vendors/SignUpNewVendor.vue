<template>
  <div>
     <div class="form">
            <form @submit.prevent="register" style="overflow-y:scroll;height:50vh">
                <h4 style="color:black"><i style="color:black" class="fa fa-user-plus"></i> Sign up new vendor</h4>

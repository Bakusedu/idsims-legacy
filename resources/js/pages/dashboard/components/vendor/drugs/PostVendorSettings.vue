...
export default {
    ...
    methods: {
        ...
        uploadSettings() {
            ...
            axios
                .post(this.url, this.data, config)
                .then((res) => {
        ...
        fetchVendorSettings() {
            ...
            fetch(this.url, config)
                .then((res) => res.json())
                .then((res) => {
                    this.data.name = res.settings.store_name
                        ? res.settings.store_name
                        : "";
                    this.data.address = res.settings.address

<template>
    <div class="drug-container">
        ...
        <div style="width: 100%; display: flex; justify-content: space-between">
            ...
            <div style="width: 39%">
                <DrugPurchaseFrequency
                    v-bind:name="this.drugDetails.name"
                    v-bind:qty="this.qty"
            ...
            <div style="width: 29%">
                <EditDrug
                    v-bind:drugDetails="this.drugDetails"
                    v-on:added="updateDrugDetails($event)"
                />
            </div>
        </div>
    </div>
...
export default {
    data() {
        return {
            ...
            purchase_url: "/api/drug_purchase/" + this.drugId,
            drugDetails: {},
            update: 0,
            error: "",
            qty: 0,
